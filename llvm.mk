...
AIT_FLAGS__        = --name=$(PROGRAM_) --board=$(BOARD) -c=$(FPGA_CLOCK) -k
AIT_FLAGS_DESIGN__ = --to_step=design
AIT_FLAGS_D__      = --debug_intfs=both

#Picos configuration
AIT_FLAGS__ +=--max_deps_per_task=3 --max_args_per_task=11 --max_copies_per_task=11 --picos_tm_size=32 --picos_dm_size=102 --picos_vm_size=102 --verbose
